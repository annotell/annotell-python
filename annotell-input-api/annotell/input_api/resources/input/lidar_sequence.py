...
class LidarsSequenceResource(CreateableInputAPIResource):
    def create(self,
               lidar_sequence: IAM.LidarsSequence,
               project: Optional[str] = None,
               batch: Optional[str] = None,
               input_list_id: Optional[int] = None,
               dryrun: bool = False) -> Optional[IAM.CreateInputJobResponse]:
        """
        Upload files and create an input of type ``lidars_sequence``.
        ...
        input of type 'lidars_sequence' is created for the designated `project` `batch` or `input_list_id`.
